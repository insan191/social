...
const EditMyProfileCover = ({ user, mouse }) => {
	const image = useRef()
	...
	return (
		<>
			{mouse === true && (
				<Popover>
					<PopoverTrigger>
						<button className='editMyProfile__info-cover'>
							<SlPencil />
							<span className='editMyProfile__info-cover-text'>
								{' '}
								Change cover
							</span>
						</button>
...
export default EditMyProfileCover
